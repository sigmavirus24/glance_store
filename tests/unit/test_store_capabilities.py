...
class TestStoreCapabilityConstants(object):
    ...
    def test_combined_capability_bits(self):
        ...
        caps.RW_ACCESS = (caps.READ_ACCESS | caps.WRITE_ACCESS)
        caps.RW_OFFSET = (caps.READ_OFFSET | caps.WRITE_OFFSET)
        caps.RW_CHUNK = (caps.READ_CHUNK | caps.WRITE_CHUNK)
        caps.RW_RANDOM = (caps.READ_RANDOM | caps.WRITE_RANDOM)
